                ...
                <li>
                  <table width="100%" cellpadding="3" cellspacing="1" >
                    <tr>
                      ...
                      <td align="left" width='50%'>仓库名称：<?php echo $this->_var['item']['store_name']; ?></td>
                    </tr>
                    <tr>
                      <td align="left" >时间段：<?php echo $this->_var['item']['rebate_paytime_start']; ?>-<?php echo $this->_var['item']['rebate_paytime_end']; ?></td>
                    ...
                    <tr>
                      <td align="left">应结金额：<?php echo $this->_var['item']['rebate_money_formated']; ?></td>
                    ...
                    <tr>
                      ...
                      <td align="left">
                        <?php $_from = $this->_var['item']['caozuo']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('i', 'do');if (count($_from)):
    foreach ($_from AS $this->_var['i'] => $this->_var['do']):
?>
                         <a href="<?php echo $this->_var['do']['url']; ?>" class="font"><?php echo $this->_var['do']['name']; ?></a><span>&nbsp;&nbsp;</span>
