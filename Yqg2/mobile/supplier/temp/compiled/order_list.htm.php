                ...
                <li>
                  <table width="100%" cellpadding="3" cellspacing="1" >
                    ...
                    <tr>
                      ...
                      <td align="right"><a href='navigate.php?act=navigate&order_id=<?php echo $this->_var['order']['order_id']; ?>' target='_blank' class="location"><img src='images/location.png' style='height:14px;'/></a>&nbsp;&nbsp;<a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>" class="font" >查看</a></td>
                    </tr>
                  </table>
                </li>
                <?php endforeach; else: ?>
