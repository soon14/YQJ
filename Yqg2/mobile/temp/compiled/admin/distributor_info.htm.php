...
?>
  ...
  <tr>
    ...
    <?php if ($this->_var['user']['face_card'] != ''): ?><img src="../<?php echo $this->_var['user']['face_card']; ?>" width="100" height="100" /><?php else: ?>暂无<?php endif; ?></td>
  </tr>
  <tr>
  	<td class="label">身份证反面：</td>
    <td>
    <input type="file" name="back_card" /><br />
    <?php if ($this->_var['user']['back_card'] != ''): ?><img src="../<?php echo $this->_var['user']['back_card']; ?>" width="100" height="100" /><?php else: ?>暂无<?php endif; ?></td>
  </tr>
  <tr>
