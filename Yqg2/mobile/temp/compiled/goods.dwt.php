...
<div class="ui-sx bian1" > 
<div class="subNavBox" > 
	<div class="subNav" style="background:none"><strong>库存：<span id="shows_number" class="fl"><?php echo $this->_var['goods']['goods_number']; ?></span>件</strong></div>
...
<div class="is_scroll">
<?php echo $this->fetch('library/select_address.lbi'); ?>
</div>
...
<div class="s_dianpu">
<span><a href="tel:<?php echo $this->_var['servicephone']; ?>" ><em class="bg1"></em>联系客服</a></span>
<span><a href="supplier.php?suppId=<?php echo $this->_var['suppid']; ?>"><em class="bg2"></em>进入店铺</a></span>
</div>
</section>
</div>
<?php endif; ?>
...
<section class="index_floor is_scroll">
    <h2>
      ...
      <div class="bd">
        <ul>
           <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_79456100_1456286000');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_79456100_1456286000']):
?>
          <li>
            <a href="<?php echo $this->_var['goods_0_79456100_1456286000']['url']; ?>">
              <div class="products_kuang">
                <img src="<?php echo $this->_var['goods_0_79456100_1456286000']['goods_thumb']; ?>"></div>
              <div class="goods_name"><?php echo htmlspecialchars($this->_var['goods_0_79456100_1456286000']['short_name']); ?></div>
              <div class="price" >
              <p href="<?php echo $this->_var['goods_0_79456100_1456286000']['url']; ?>"><?php echo $this->_var['goods_0_79456100_1456286000']['fittings_price']; ?> </p>
                 <a href="javascript:addToCart(<?php echo $this->_var['goods_0_79456100_1456286000']['goods_id']; ?>);" class="car">
                    <img src="themesmobile/68ecshopcom_mobile/images/xin/cutp.png">
                </a>
              </div>
            </a>
