...
?>
        ...
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <div class="anniu" style=" width:95%">
                  ...
                  <?php else: ?> 
                    <a href="user.php?act=comment_order&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>" class="on_comment">评价</a>
                  <?php endif; ?>
                  <?php if ($this->_var['goods']['shaidan_state']): ?>
                  <?php else: ?>  
                  <a href="user.php?act=shaidan_send&id=<?php echo $this->_var['goods']['rec_id']; ?>" class="on_comment">晒单</a> 
                  <?php endif; ?>
                  <?php endif; ?>
