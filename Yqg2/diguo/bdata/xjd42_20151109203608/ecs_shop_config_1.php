...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','小京东V4.2-多城市多仓库 带分销系统','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','小京东V4.2-多城市多仓库 带分销系统','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','小京东V4.2-多城市多仓库 带分销系统','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','小京东V4.2-多城市多仓库 带分销系统','1');");
...
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','138','1');");
...
E_D("replace into `ecs_shop_config` values('317','3','goods_name_length','text','','','10','1');");
...
E_D("replace into `ecs_shop_config` values('1011','1','comment_youxiaoqi','text','','','30','1');");
...
E_D("replace into `ecs_shop_config` values('1018','1','okgoods_time','text','','','4','1');");
E_D("replace into `ecs_shop_config` values('1019','1','okback_time','text','','','7','1');");
E_D("replace into `ecs_shop_config` values('1020','1','delback_time','text','','','7','1');");
