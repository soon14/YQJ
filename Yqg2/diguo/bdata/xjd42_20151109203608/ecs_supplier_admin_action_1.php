...
E_D("replace into `ecs_supplier_admin_action` values('7','0','jxc_manage','');");
E_D("replace into `ecs_supplier_admin_action` values('141','7','inout_in_manage','');");
E_D("replace into `ecs_supplier_admin_action` values('142','7','inout_out_manage','');");
E_D("replace into `ecs_supplier_admin_action` values('143','7','store_manage','');");
E_D("replace into `ecs_supplier_admin_action` values('144','7','store_shipping_demo','');");
E_D("replace into `ecs_supplier_admin_action` values('145','7','store_inout_goods','');");
E_D("replace into `ecs_supplier_admin_action` values('146','7','store_inout_stock','');");
E_D("replace into `ecs_supplier_admin_action` values('147','7','store_inout_type','');");
E_D("replace into `ecs_supplier_admin_action` values('148','7','store_rebate','');");
