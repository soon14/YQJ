...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='在线聊天客服信息表'");
E_D("replace into `ecs_chat_customer` values('3','3','1111','售前服务','-1','1','0','0','0','1','1439580348');");
E_D("replace into `ecs_chat_customer` values('4','4','lanseaiyu','狐狸','-1','1','0','0','0','1','1439765377');");
