...
E_D("replace into `ecs_admin_action` values('13','0','jxc_manage','');");
E_D("replace into `ecs_admin_action` values('213','13','inout_in_manage','');");
E_D("replace into `ecs_admin_action` values('214','13','inout_out_manage','');");
E_D("replace into `ecs_admin_action` values('215','13','store_manage','');");
E_D("replace into `ecs_admin_action` values('216','13','store_shipping_demo','');");
E_D("replace into `ecs_admin_action` values('217','13','store_inout_goods','');");
E_D("replace into `ecs_admin_action` values('218','13','store_inout_stock','');");
E_D("replace into `ecs_admin_action` values('219','13','store_inout_type','');");
E_D("replace into `ecs_admin_action` values('220','0','pickup_point','');");
E_D("replace into `ecs_admin_action` values('221','220','pickup_point_manage','');");
E_D("replace into `ecs_admin_action` values('222','220','pickup_point_batch','');");
E_D("replace into `ecs_admin_action` values('223','8','send_mail','');");
E_D("replace into `ecs_admin_action` values('224','1','question_manage','');");
E_D("replace into `ecs_admin_action` values('225','1','shaidan_manage','');");
E_D("replace into `ecs_admin_action` values('138','12','supplier_rebate','');");
E_D("replace into `ecs_admin_action` values('226','13','store_rebate','');");
