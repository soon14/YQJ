...
E_D("replace into `ecs_supplier_tag_map` values('1','2');");
E_D("replace into `ecs_supplier_tag_map` values('1','5');");
E_D("replace into `ecs_supplier_tag_map` values('1','6');");
E_D("replace into `ecs_supplier_tag_map` values('2','2');");
E_D("replace into `ecs_supplier_tag_map` values('2','5');");
E_D("replace into `ecs_supplier_tag_map` values('2','7');");
E_D("replace into `ecs_supplier_tag_map` values('3','5');");
E_D("replace into `ecs_supplier_tag_map` values('3','6');");
E_D("replace into `ecs_supplier_tag_map` values('3','7');");
