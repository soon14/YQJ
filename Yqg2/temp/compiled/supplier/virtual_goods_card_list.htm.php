...
<form method="POST" action="virtual_goods_card.php?act=batch_drop_card&goods_id=<?php echo $this->_var['goods_id']; ?>" name="listForm">
<!-- start card list -->
...
<?php endif; ?>
  ...
  <table cellpadding="3" cellspacing="1">
   ...
   <!--   <th>
      ...
      <th><?php echo $this->_var['lang']['order_price']; ?></th>
      <th><?php echo $this->_var['lang']['add_date']; ?></th>
      <th><?php echo $this->_var['lang']['buy_date']; ?></th>
...
?>
    <tr>
      ...
      <td align="center"><input value="<?php echo $this->_var['card']['card_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['card']['card_sn']; ?></td>
      <td align="center"><span><a href="order.php?act=info&order_id=<?php echo $this->_var['card']['order_id']; ?>"><?php echo $this->_var['card']['order_sn']; ?></a></span></td>
      ...
      <td align="center"><span><?php echo $this->_var['card']['buy_date']; ?></span></td>
