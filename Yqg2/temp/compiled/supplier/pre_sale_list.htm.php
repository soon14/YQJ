...
?>
    <tr>
      ...
      <td><?php echo htmlspecialchars($this->_var['pre_sale']['goods_name']); ?></td>
      ...
      <td align="center">
        ...
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['pre_sale']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16" /></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
