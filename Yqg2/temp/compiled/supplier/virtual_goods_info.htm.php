      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <td><input type="text" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"  size="30" />
		  ...
		  <div>
                  ...
                  <tr>
                      ...
                      <td id="area" class="goods_select_area">
                         ...
                         <?php $_from = $this->_var['district']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'district_0_97939500_1445507606');if (count($_from)):
    foreach ($_from AS $this->_var['district_0_97939500_1445507606']):
?>
                            <span><?php echo $this->_var['district_0_97939500_1445507606']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_97939500_1445507606']['district_id']; ?>,'<?php echo $this->_var['district_0_97939500_1445507606']['district_name']; ?>')>x</a></span>
                            <script>
                               strdistrict_name.push("<span><?php echo $this->_var['district_0_97939500_1445507606']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_97939500_1445507606']['district_id']; ?>,'<?php echo $this->_var['district_0_97939500_1445507606']['district_name']; ?>')>x</a></span>");
                            </script>
		  ...
		  <td >
                      <select name="select_city"  size="8" onchange=getCountyList()>
                          <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city_0_98034800_1445507606');if (count($_from)):
    foreach ($_from AS $this->_var['city_0_98034800_1445507606']):
?>
                          <option value="<?php echo $this->_var['city_0_98034800_1445507606']['city']; ?>"><?php echo $this->_var['city_0_98034800_1445507606']['region_name']; ?></option>
                          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                      </select>
