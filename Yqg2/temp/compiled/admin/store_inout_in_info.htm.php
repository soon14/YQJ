...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        <?php if ($_GET['act'] == 'edit'): ?>
        <td   align=center><a href="store_inout_in.php?act=remove&id=<?php echo $this->_var['inout']['rec_id']; ?>" onclick="return confirm('你确认要删除吗？')" >删除</a>&nbsp;&nbsp; <a href="javascript:showDiv(<?php echo $this->_var['inout']['rec_id']; ?>, '2', '提交审核');">提交审核</a></td>
        <?php endif; ?> </tr>
    </table>
    <div class="blank"></div>
    <ul class="inout_info">
...
?>
      <tr>
        <td align=center><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" width=50 height=50>
          <input type="hidden" name="goods_id[]" value="<?php echo $this->_var['goods']['goods_id']; ?>"></td>
        <td align=center><?php echo $this->_var['goods']['goods_sn']; ?>
          <input type="hidden" name="goods_sn[]" value="<?php echo $this->_var['goods']['goods_sn']; ?>"></td>
        <td><?php echo $this->_var['goods']['goods_name']; ?></td>
        <td align=center><?php echo nl2br($this->_var['goods']['goods_attr1']); ?>
          <input type="hidden" name="goods_attr[]" value="<?php echo $this->_var['goods']['goods_attr2']; ?>" ></td>
        <td align=center><?php echo $this->_var['goods']['number_yingshou']; ?>
          <input type="hidden" name="number_yingshou[]" value="<?php echo $this->_var['goods']['number_yingshou']; ?>"></td>
        <td align=center><input type="text" name="number_shishou[]" value="<?php echo $this->_var['goods']['number_shishou']; ?>"></td>
        <td align=center><a href="javascript:void(0);" onclick="removeProduct(this)" >删除</a></td>
      </tr>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      <?php endif; ?>
    </table>
...
function validate()
{
  ...
  function get_goodsInfo_bysn_response(result)
  {
	  if (result.error)
	  {
		  ...
		  document.getElementById('goods_name').value= result.message;
