            ...
            <div id="brand_content" style="margin-top:5px; margin-bottom:10px; display:none">
              <div style="float:left; overflow-y:scroll; width:420px; height:120px; border:#CCC 1px solid">
                ...
                <table width="400" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td valign="top" style="padding-left:10px"><!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list']['name_p'] >= "a" && $this->_var['brand_list']['name_p'] <= "g"): ?> -->
                      
                      <div id="@<?php echo $this->_var['key']; ?>">
                        <div id="<?php echo $this->_var['brand_list']['name_pinyin']; ?><?php echo $this->_var['brand_list']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list']['name']; ?>')"><?php echo $this->_var['brand_list']['name']; ?></a></div>
                      </div>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list']['name_p'] >= "h" && $this->_var['brand_list']['name_p'] <= "k"): ?> -->
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list']['name_p'] >= "l" && $this->_var['brand_list']['name_p'] <= "s"): ?> -->
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list']['name_p'] >= "t" && $this->_var['brand_list']['name_p'] <= "z"): ?> -->
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list']):
?> --> 
                      <!-- <?php if ($this->_var['brand_list']['name_p'] >= "0" && $this->_var['brand_list']['name_p'] <= "9"): ?> -->
